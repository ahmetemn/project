...
import "./HastanePhoto.css"
import HastanePhotoPagination from './HastanePhotoPagination';
const HastanePhoto = ({buttonClicked}) => {
    ...
    useEffect(() => {
        ...
        try {
            fetch("http://localhost:3002/hastane/hastanephoto",
                {
                    method: "POST",
